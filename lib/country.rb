...
class Country
  ...
  COUNTRIES = [
    ...
    { alpha2: 'UM', name: 'Minor Outlying Islands, U.S.', alpha3: 'UMI', numeric: '581' },
    ...
    { alpha2: 'TW', name: 'Taiwan', alpha3: 'TWN', numeric: '158' }, # Province of China removed.
  ...
  def to_s(format = nil)
    # default to :alpha2 so you can pass Country objects
